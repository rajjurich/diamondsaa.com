<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Ticker_Details.aspx.vb" Inherits="Ticker_Details" %>
        ...
        <table id="content" width="1000" cols = "3" border="0" cellpadding="0" cellspacing="0" align="center">
            ...
            <tr>
                <td colspan ="4" align = "center" id="colTwo">
                    <strong><asp:Label ID="Label1" runat="server" Text="Ticker Details :"></asp:Label></strong><br /><br />
                    <div>
                    <asp:GridView ID="GridView_TickerDetails" runat="server">
            
                    </asp:GridView>
                    </div>
                    <br />
                    <asp:Button ID="BtnGoMain" runat="server" Text="Go to Main" />
                    <asp:Button ID="btnNew" runat="server" Text="New" Width="70px" />
