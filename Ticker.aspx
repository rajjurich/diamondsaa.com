<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Ticker.aspx.vb" Inherits="Ticker" %>
        ...
        <table id="content" width="1000" cols = "3" border="0" cellpadding="0" cellspacing="0" align="center">
            ...
            <tr>
                <td colspan ="4" align = "center" id="colTwo">
                    <table id="Table1" cols = "2" runat = "server" >
            <tr>
                <td colspan ="1"><asp:Label ID="Label1" runat="server" Text="Ticker Id"></asp:Label></td>
                <td colspan ="1" style="width: 193px"><asp:TextBox ID="txtTickerId" runat="server" Width="188px"></asp:TextBox></td>
            </tr>
            <tr>
                <td colspan ="1"><asp:Label ID="Label2" runat="server" Text="Ticker"></asp:Label></td>
                <td colspan ="1" style="width: 193px"><asp:TextBox ID="txtTickerDesc" runat="server" Width="188px"></asp:TextBox></td>
            </tr> 
            <tr>
                <td colspan ="1">&nbsp;</td>
                <td colspan ="1" style="width: 193px" align="left"><asp:Label ID="lblStatus" runat="server" Text=""></asp:Label></td>
            </tr> 
            <tr>
                <td colspan ="1" style="height: 26px">&nbsp;</td>
                <td colspan ="1" align ="right" style="height: 26px; width: 193px;"><asp:Button ID="BtnSubmit" runat="server" Text="SUBMIT" /></td>
            </tr> 
        </table>
                </td>
            </tr>
