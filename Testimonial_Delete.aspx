<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Testimonial_Delete.aspx.vb" Inherits="Testimonial_Delete" %>
                ...
                <td colspan ="4" align = "center" id="colTwo">
                    ...
                    <table cols ="2">
                        <tr>
                            ...
                            <td colspan ="1" style="width: 502px; height: 24px;" align="left"><asp:DropDownList ID="cmbTestimonialId" AutoPostBack = "true" OnTextChanged="cmbTestimonialId_TextChanged" runat="server"></asp:DropDownList></td>
                        </tr>
                        <tr>
                            <td colspan ="1"><asp:Label ID="Label2" runat="server" Text="Testimonial"></asp:Label></td>
                            <td colspan ="1" style="width: 502px"><asp:TextBox ID="txtTestimonial" runat="server" Width="529px"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td colspan ="1">&nbsp;</td>
