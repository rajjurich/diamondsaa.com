<%@ Page Language="VB" AutoEventWireup="false" CodeFile="team_A.aspx.vb" Inherits="team_A" %>
...
<div id="menu">
    <ul>
	<li><a href="player_info.aspx">Player Info</a>
    <ul>
    <li><a href="team_A.aspx">Team A</a></li>
    <li><a href="team_B.aspx">Team B</a></li>
    <li><a href="Coach.aspx">Coach</a></li>
    <li><a href="Members.aspx" title="">Members</a></li>
    </ul>
    </li>
	<li><a href="fees_dues.aspx" title="">Fees Dues</a></li>
	<li><a href="Internal_circulars.aspx" title="">Internal circulars</a></li>
	<li><a href="Training.aspx" title="">Training Tips</a></li>
    ...
    <td colspan="5">
    	<table width="1000" cols="5" align="center" id="content">
        	<tr valign="top">
                ...
                <h2>Teams A Dtails:</h2>
              
                 <div><strong><u>Coach : Denis George</u></strong></div><br />
