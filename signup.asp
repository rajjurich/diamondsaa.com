...
<table width="707" border="0"><form action="insd.asp" method="post"  name="form1" id="form1">
  <tr>
    <td width="107">&nbsp;</td> 
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td width="152" style="font-size:14px"><font color="#FF0000">*</font>Full Name</td>
    <td width="420">
      
      <input type="text" name="textfield" id="textfield" size="26px" />
  ...
  <tr>
    <td>&nbsp;</td>
    <td><font color="#FF0000">*</font>Residential address</td>
    <td>
      <input type="text" name="textfield3" id="textfield3" size="26px"/>
    </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><font color="#FF0000">*</font>Office address</td>
    <td>
      <input type="text" name="txtOfficeAddress" id="textfield3" size="26px" />
    </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><font color="#FF0000">*</font>Mobile</td>
    <td>
      <input type="text" name="textfield4" id="textfield4" size="26px" />
    </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><font color="#FF0000">*</font>Office Tel. No</td>
    <td>
      <input type="text" name="txtOffTelNo" id="textfield4" size="26px" />
    </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td>
      <input type="text" name="textfield2" id="textfield2" size="26px" />
    </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><font color="#FF0000">*</font>In Diamond since</td>
    <td>
      <input type="text" name="textfield5" id="textfield5" size="26px" />
    </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><font color="#FF0000">*</font>Sports</td>
    <td>
      <input type="text" name="textfield6" id="textfield6" size="26px" />
    </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><font color="#FF0000">*</font>Acheivement</td>
    <td>
      <input type="text" name="textfield7" id="textfield7" size="26px" />
    </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><font color="#FF0000">*</font>Feild position</td>
    <td>
      <input type="text" name="textfield8" id="textfield8" size="26px" />
    </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td valign="top"><font color="#FF0000">*</font>About Me</td>
    <td>
      <textarea name="textfield9" cols="20" rows="3" ></textarea>
    </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Attachment :</td>
    <td>
      <a href="/downloads/APPLICATION_FOR_MEMEBRSHIP.pdf" target="_blank">APPLICATION_FOR_MEMEBRSHIP.pdf (24 KB)</a>
    </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td>&nbsp;</td>
    <td>
      (<strong>Note :</strong> Please download this attachement if you want to complete the process of membership, and then submit it to the office.)
    </td>
    <td>&nbsp;</td>
  </tr></form>
</table>
